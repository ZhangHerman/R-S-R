...
NUM_THREADS = 100
VIDEO_ROOT = '/raid5/zyk_data/something-v1/20bn-something-something-v2/'         # Downloaded webm videos
FRAME_ROOT = '/raid5/zyk_data/something-v1/something-v2-frames/'  # Directory for extracted frames
